...
/***/ function(module, exports, __webpack_require__) {
	...
	function createInstance() {
	  ...
	  var config = _ref$config === undefined ? (0, _cli.getConfig)({ useCLI: isRunFromCLI() }).argv : _ref$config;
	  var _ref$runAsBinary = _ref.runAsBinary;
	  var runAsBinary = _ref$runAsBinary === undefined ? false : _ref$runAsBinary;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getConfig() {
	  ...
	  var _ref$useCLI = _ref.useCLI;
	  var useCLI = _ref$useCLI === undefined ? true : _ref$useCLI;
	...
	var Linter = function () {
	  ...
	  _createClass(Linter, [{
	    ...
	    value: function toJSON() {
	      ...
	      var input = _ref$input === undefined ? this.output : _ref$input;
	      var _ref$pretty = _ref.pretty;
	      var pretty = _ref$pretty === undefined ? this.config.pretty : _ref$pretty;
	      var _ref$_JSON = _ref._JSON;
	
	      var _JSON = _ref$_JSON === undefined ? JSON : _ref$_JSON;
	    ...
	    value: function getAddonMetadata() {
	      ...
	      var _log = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _logger2.default;
	      ...
	      return this.io.getFiles().then(function (files) {
	        if (files.hasOwnProperty(_const.INSTALL_RDF) && files.hasOwnProperty(_const.MANIFEST_JSON)) {
	          ...
	          return _this2.io.getFileAsString(_const.MANIFEST_JSON).then(function (json) {
	            var manifestParser = new _manifestjson2.default(json, _this2.collector);
	    ...
	    value: function extractMetadata() {
	      ...
	      var _ref2$_Crx = _ref2._Crx;
	
	      var _Crx = _ref2$_Crx === undefined ? _io.Crx : _ref2$_Crx;
	
	      var _ref2$_console = _ref2._console;
	
	      var _console = _ref2$_console === undefined ? console : _ref2$_console;
	
	      var _ref2$_Directory = _ref2._Directory;
	
	      var _Directory = _ref2$_Directory === undefined ? _io.Directory : _ref2$_Directory;
	
	      var _ref2$_Xpi = _ref2._Xpi;
	
	      var _Xpi = _ref2$_Xpi === undefined ? _io.Xpi : _ref2$_Xpi;
	    ...
	    value: function scan() {
	      ...
	      return this.extractMetadata(deps).then(function () {
	        ...
	        if (_this5.config.runAsBinary === true) {
	          process.exit(_this5.output.errors.length > 0 ? 1 : 0);
	        }
	      }).catch(function (err) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function walkPromise(curPath) {
	  ...
	  var _ref$shouldIncludePat = _ref.shouldIncludePath;
	  var shouldIncludePath = _ref$shouldIncludePat === undefined ? function () {
	    return true;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.PROP_VERSION_MISSING = exports.PROP_NAME_MISSING = exports.MANIFEST_UNUSED_UPDATE = exports.MANIFEST_UPDATE_URL = exports.PROP_VERSION_TOOLKIT_ONLY = exports.PROP_VERSION_INVALID = exports.PROP_NAME_INVALID = exports.MANIFEST_CSP = exports.MANIFEST_VERSION_INVALID = exports.MANIFEST_PERMISSIONS = exports.MANIFEST_BAD_PERMISSION = exports.MANIFEST_FIELD_INVALID = exports.MANIFEST_FIELD_REQUIRED = undefined;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InstallRdfParser = function () {
	  function InstallRdfParser(xmlDoc, collector) {
	    ...
	    var namespace = _ref$namespace === undefined ? _const.RDF_DEFAULT_NAMESPACE : _ref$namespace;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ManifestJSONParser = function (_JSONParser) {
	  ...
	  function ManifestJSONParser(jsonString, collector) {
	    ...
	    var filename = _ref$filename === undefined ? _const.MANIFEST_JSON : _ref$filename;
	    var _ref$RelaxedJSON = _ref.RelaxedJSON;
	    var RelaxedJSON = _ref$RelaxedJSON === undefined ? _relaxedJson2.default : _ref$RelaxedJSON;
	    var _ref$selfHosted = _ref.selfHosted;
	    var selfHosted = _ref$selfHosted === undefined ? (0, _cli.getConfig)().argv.selfHosted : _ref$selfHosted;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var JSONParser = function () {
	  function JSONParser(jsonString, collector) {
	    ...
	    var _ref$filename = _ref.filename;
	    var filename = _ref$filename === undefined ? null : _ref$filename;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function invalidNesting(cssNode, filename) {
	  ...
	  var startColumn = _ref.startColumn;
	...
	var JavaScriptScanner = function () {
	  ...
	  _createClass(JavaScriptScanner, [{
	    ...
	    value: function scan() {
	      ...
	      var _ref$_rules = _ref._rules;
	
	      var _rules = _ref$_rules === undefined ? this._defaultRules : _ref$_rules;
	
	      var _ref$_ruleMapping = _ref._ruleMapping;
	
	      var _ruleMapping = _ref$_ruleMapping === undefined ? _const.ESLINT_RULE_MAPPING : _ref$_ruleMapping;
	
	      var _ref$_messages = _ref._messages;
	
	      var _messages = _ref$_messages === undefined ? messages : _ref$_messages;
