...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__webpack_require__.c[0] === module) {
	  cli = __webpack_require__(16).default;
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _versions = __webpack_require__(14);
	
	var _naturalCompareLite = __webpack_require__(15);
	  ...
	  _createClass(Dispensary, [{
	    ...
	    value: function run() {
	      ...
	      return this.getLibraries().then(function (libraries) {
	        return (0, _versions.getVersions)(libraries);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports._getVersionsFromNPM = _getVersionsFromNPM;
	exports._handleNPMResponseData = _handleNPMResponseData;
	...
	function getVersions(libraries) {
	  var maxRequests = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 35;
	
	  return new Promise(function (resolve) {
	    var queue = _async2.default.queue(_getVersionsFromNPM, maxRequests);
	
	    queue.drain = function () {
	      _logger2.default.debug('All versions obtained.');
	      resolve(libraries);
	    };
	    ...
	    try {
	      for (var _iterator = libraries[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	    ...
	    queue.push(libraries.filter(function (library) {
	      return library.useNPM === true;
	    }));
	  });
	}
	
	function _getVersionsFromNPM(library, callback) {
	  var _request = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : _request3.default;
	  ...
	  _request.get({
	    ...
	    if (err || !response || response.statusCode !== 200) {
	      ...
	      _logger2.default.info('node module "' + repo + '" not found or an error occured');
	      return callback(new Error('RequestError: npm "' + repo + '" (statusCode: ' + statusCode + ')'));
	    }
	...
	function _handleNPMResponseData(library, data) {
	  var versions = Object.keys(data.versions).filter(function (version) {
